...
(:process decay-2
		...
		:effect
		(and
			(increase (pr) (* #t (* -1 0.7167242941)))
		)
	)
	
(:process decay-3
		:parameters ()
		:precondition (> (pr) 299.999)
		:effect
		(and
			(increase (pr) (* #t (* -1 0.565197586196)))
		)
	)
...
(:process decay-4
		...
		:effect
		(and
			(increase (pr) (* #t (* -1 1.45897812549)))
		)
	)
	
(:process decay-5
		:parameters ()
		:precondition (> (pr) 1114.41)
		:effect
		(and
			(increase (pr) (* #t (* -1 1.64699024569)))
		)
	)
